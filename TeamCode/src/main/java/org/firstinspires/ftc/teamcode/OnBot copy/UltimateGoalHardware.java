...
public class UltimateGoalHardware
{
    ...
    /**
     * Lower arm driving motor.
     */
    public DcMotor mLowerArmDrive;

    /**
     * Upper arm driving motor.
     */
    public DcMotor mUpperArmDrive;
     ...
     */
    //private RobotArm            mLowerArm; not used in Ultimate Goal
    ...
    //Servo to operate wobbleDrop.
    
    public Servo            mWobbleDrop;//used in Ultimate Goal
    ...
    /* Constructor */
    public UltimateGoalHardware(OpMode owner, TelemetryLogger logger)
    {
    ...
    private void initMotors()
    {
        ...
        //Prepare the arm motors. //not used in Ultimate Goal
        //mLowerArmDrive = mHardwareMap.get(DcMotor.class, "lowerarm");
        //mUpperArmDrive = mHardwareMap.get(DcMotor.class, "upperarm");

        //mUpperArmDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        //mLowerArmDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);

        //mUpperArmDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        //mLowerArmDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        // Setting power to 0 must brake the arms by default.
        //mUpperArmDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        //mLowerArmDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);

        //mLowerArm = new RobotArmHexCore("Lower", mOwner, mLogger, mLowerArmDrive, false);
    ...
    private void initServos()
    {
        ...
        mWobbleDrop = mHardwareMap.get(Servo.class, "wobbleDrop");
        mWobbleDrop.setDirection(Direction.FORWARD);
        mWobbleDrop.setPosition(0.0);

        /*mGripAlignServo = mHardwareMap.get(Servo.class, "gripalign");
        mGripAlignServo.setDirection(Direction.FORWARD);
        mGripAlignServo.setPosition(0.0);
