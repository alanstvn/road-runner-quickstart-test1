...
public class TelemetryLogger
{
     ...
     */
    public TelemetryLogger(OpMode owner, String caption, String value)
    {
        mOwner = owner;
     ...
     * @param caption       Caption where this logger logs its information.
     */
    public TelemetryLogger(OpMode owner, String caption)
    {
        this(owner, caption, "");
    }
     ...
     */
    TelemetryLogger setLogState(LogState state)
    {
        mLogState = state;
        return(this);
    }
